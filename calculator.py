...
input_frame = Frame(win, highlightbackground="black", highlightcolor="black", highlightthickness=5 ,width=312, height=50, bd=0)
...
#Let us creating another 'Frame' for the buttons below the 'input_frame'
...
clear = Button(btns_frame, text = "C", fg = "black", width = 30, height = 3, bd = 0, bg = "#eee", cursor = "hand2",
